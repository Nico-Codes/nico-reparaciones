...
- `GET /api/store/branding` ya alimenta no solo logo/iconos/favicons sino tambien las variantes `desktop/mobile` del fondo visual del shell de auth, usadas como imagen real del panel izquierdo y no como decoracion CSS generada
...
- la pagina principal queda centrada en:
  ...
  - edicion del copy y colores independientes del panel visual de auth
