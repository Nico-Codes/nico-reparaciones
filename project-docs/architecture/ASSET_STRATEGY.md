...
- el fondo visual del login tambien se administra como asset de branding desde `AdminVisualIdentityPage` con dos variantes (`desktop` y `mobile`) y se expone al frontend publico via `/api/store/branding`
