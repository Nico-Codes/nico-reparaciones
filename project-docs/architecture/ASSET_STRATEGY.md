...
- el fondo visual del login tambien se administra como asset de branding desde `AdminVisualIdentityPage` y se expone al frontend publico via `/api/store/branding`
