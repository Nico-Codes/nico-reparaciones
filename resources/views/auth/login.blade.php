...
<div class="store-shell mx-auto w-full max-w-md px-4">
  ...
  <div class="card rounded-3xl p-5 sm:p-6 reveal-item">
    <div class="mb-5">
      <div class="text-xs font-black uppercase tracking-wide text-sky-700">Cuenta</div>
      <h2 class="text-lg font-black tracking-tight text-zinc-900">Inicia sesion</h2>
      <p class="mt-1 text-sm text-zinc-600">Usa tu email y contrasena.</p>
    </div>
