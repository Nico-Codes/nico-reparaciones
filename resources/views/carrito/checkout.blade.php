...
@section('content')
  ...
  @if ($errors->any())
    <div class="alert-error mb-4">
      <div class="font-black">Revisa estos datos:</div>
            ...
            <div class="grid gap-3">
              ...
              <div class="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                <label class="block cursor-pointer">
                  ...
                  <div class="rounded-2xl border border-zinc-200 bg-white p-4 transition hover:bg-zinc-50 peer-checked:border-sky-300 peer-checked:bg-sky-50 peer-checked:ring-2 peer-checked:ring-sky-100">
            ...
            <div class="rounded-2xl border border-zinc-200 bg-zinc-50 p-4 sm:p-5">
              <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div class="min-w-0">
                  ...
                  <div class="mt-2 grid gap-1 text-sm text-zinc-700">
                    ...
                    <div><span class="font-black">Telefono:</span> {{ $u->phone ?? '-' }}</div>
              ...
              @if($needsProfile)
                <div class="mt-3 rounded-2xl border border-rose-200 bg-rose-50 px-4 py-3 text-sm text-rose-900">
                  ...
                  <div class="mt-1">Agrega tu apellido y telefono para confirmar pedidos.</div>
                </div>
              @endif
            </div>
