...
@section('content')
  <div class="store-shell">
    <div class="mb-5 rounded-3xl border border-emerald-200 bg-emerald-50 p-4 sm:p-5 reveal-item">
      ...
      <div class="card lg:col-span-2 reveal-item">
        ...
        <div class="card-body grid gap-4">
          ...
          <div class="flex flex-col gap-2 pt-2 sm:flex-row sm:flex-wrap">
            <a class="btn-outline h-11 w-full justify-center sm:w-auto" href="{{ route('orders.show', $order->id) }}">Ver detalle</a>
            <a class="btn-outline h-11 w-full justify-center sm:w-auto" href="{{ route('orders.index') }}">Mis pedidos</a>
            <a class="btn-primary h-11 w-full justify-center sm:w-auto" href="{{ route('store.index') }}">Seguir comprando</a>

            @if(!empty($waNumber))
              <textarea id="nrWaText" class="hidden" readonly>{{ $waText }}</textarea>

              <a class="btn-ghost h-11 w-full justify-center sm:w-auto"
