...
<div class="space-y-4">
  <div class="page-head">
    <div>
      ...
      <div class="page-subtitle">Estos son los “módulo / batería / mantenimiento …” usados en el cálculo automático.</div>
    </div>
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('admin.repairTypes.store') }}" class="space-y-3">
          ...
          <div class="space-y-1">
            ...
            <input class="h-11" name="name" placeholder="Ej: Módulo" required>
          </div>
        ...
        <div class="space-y-2">
          ...
          @empty
            <div class="rounded-2xl border border-dashed border-zinc-300 bg-zinc-50 px-3 py-4 text-sm text-zinc-600">
              No hay tipos de reparación cargados.
            </div>
          @endforelse
        </div>
      </div>
