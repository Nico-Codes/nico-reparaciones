  ...
  <div class="reveal-item rounded-3xl border border-zinc-200/80 bg-gradient-to-r from-white via-sky-50/60 to-white p-4 sm:p-6">
    <div class="page-head mb-0">
      <div>
        ...
        <div class="page-subtitle">Mas especifico implica mayor prioridad (Modelo > Grupo > Marca > Generico).</div>
      </div>
    ...
    <form method="POST" action="{{ route('admin.pricing.store') }}" class="space-y-4" data-pricing-create-form>
      ...
      <div class="grid gap-4 sm:grid-cols-2">
        ...
        <div class="space-y-1 sm:col-span-2">
          ...
          <div class="text-xs text-zinc-500">Si eliges modelo, pisa marca y grupo.</div>
        </div>
      </div>
      ...
      <div class="grid gap-4 sm:grid-cols-2">
        <div class="space-y-1">
          ...
          <select name="mode" class="h-11" required data-pricing-mode-select>
            <option value="margin" @selected($mode === 'margin')>Margen (porcentaje + minimo)</option>
        ...
        <div class="space-y-1">
          ...
          <div class="text-xs text-zinc-500">Si no hay envio, coloca 0.</div>
        </div>
        ...
        <div class="space-y-1" data-pricing-mode="margin">
          <label class="text-sm font-semibold">Minimo de ganancia</label>
        ...
        <div class="space-y-1">
          ...
          <div class="text-xs text-zinc-500">Si hay empate de especificidad, gana mayor prioridad.</div>
        </div>
      </div>
