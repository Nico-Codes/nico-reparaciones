...
<div class="store-shell space-y-6">
  ...
  <div class="reveal-item card">
    <div class="card-head">
      <div>
        ...
        <div class="text-xs text-zinc-500">Elegi tipo y marca para crear o editar grupos.</div>
      </div>
    </div>
  ...
  @if(!$brandId)
    <div class="reveal-item card">
      <div class="card-body text-sm text-zinc-600">Elegi un tipo y una marca para administrar grupos y asignar modelos.</div>
    </div>
  @else
      ...
      <div class="card">
        ...
        <div class="card-body border-t border-zinc-100">
          ...
          <div class="space-y-2">
            ...
            @empty
              <div class="rounded-2xl border border-dashed border-zinc-300 bg-zinc-50 px-3 py-4 text-sm text-zinc-600">No hay grupos cargados para esta marca.</div>
            @endforelse
          </div>
        </div>
      </div>
      ...
      <div class="card" data-admin-model-groups>
        ...
        <div class="card-body">
          <div class="space-y-2">
            ...
            @empty
              <div class="rounded-2xl border border-dashed border-zinc-300 bg-zinc-50 px-3 py-4 text-sm text-zinc-600">No hay modelos para esta marca.</div>
            @endforelse
          </div>
        </div>
      </div>
