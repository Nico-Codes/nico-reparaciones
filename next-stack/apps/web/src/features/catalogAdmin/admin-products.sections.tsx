...
type AdminProductsStatsGridProps = {
...
type AdminProductsCatalogSectionProps = {
  loading: boolean;
  error: string;
  hasFilters: boolean;
...
export function AdminProductsStatsGrid({ stats }: AdminProductsStatsGridProps) {
  return (
    <section className="nr-stat-grid" data-reveal>
      <MetricCard label="Catalogo visible" value={String(stats.total)} meta="Productos cargados en esta vista operativa" />
      ...
      <MetricCard label="Stock critico" value={String(stats.lowStock + stats.noStock)} meta="Items con poco stock o agotados" />
    </section>
  );
}
...
export function AdminProductsFilters({
  ...
  return (
    ...
    >
      ...
      />
      <SelectField label="Categoria" value={categoryId} onChange={onCategoryIdChange} options={categoryOptions} ariaLabel="Filtrar por categoria" />
      <SelectField label="Estado" value={activeFilter} onChange={onActiveFilterChange} options={ADMIN_PRODUCTS_ACTIVE_OPTIONS} ariaLabel="Filtrar por estado" />
      <SelectField label="Destacado" value={featuredFilter} onChange={onFeaturedFilterChange} options={ADMIN_PRODUCTS_FEATURED_OPTIONS} ariaLabel="Filtrar por destacado" />
      <SelectField label="Stock" value={stockFilter} onChange={onStockFilterChange} options={ADMIN_PRODUCTS_STOCK_OPTIONS} ariaLabel="Filtrar por stock" />
    </FilterBar>
  );
}

export function AdminProductsCatalogSection({
  loading,
  error,
  hasFilters,
  filteredProducts,
  ...
  onClearFilters,
  onPatchProduct,
}: AdminProductsCatalogSectionProps) {
  return (
    <SectionCard
