    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
          <div className="font-black">No hay items validos para confirmar</div>
          <div className="mt-2 text-sm text-zinc-600">Volve al carrito para revisar stock y productos.</div>
        </div>
      ) : (
