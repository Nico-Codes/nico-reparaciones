  ...
  return (
    <div className="store-shell space-y-5">
      ...
      <section className="grid gap-4 md:grid-cols-2">
        ...
        <Link
          to="/admin/calculos/reparaciones"
          className="card block transition hover:-translate-y-0.5 hover:shadow-[0_14px_34px_-24px_#0f172a33]"
        >
          <div className="card-body p-4 md:p-5">
            <div className="text-xl font-black tracking-tight text-zinc-900">Reparaciones</div>
            <p className="mt-2 text-sm leading-6 text-zinc-600">
              Catalogo tecnico, grupos, fallas y reglas por scope para calculo automatico.
            </p>
            <div className="mt-4 text-sm font-black text-sky-700">Abrir hub de reparaciones</div>
          </div>
        </Link>
      </section>
    </div>
