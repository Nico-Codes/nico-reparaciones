...
export function AdminDashboardSummarySection({
  loading,
  summary,
}: {
  loading: boolean;
      ...
      {loading || !summary ? (
        ...
        <div className="admin-dashboard-summary-grid">
          <SummaryLinkCard
            ...
            description="Reparaciones que requieren revision tecnica inicial."
            to="/admin/repairs"
            tone="info"
          />
          <SummaryLinkCard
          ...
          <SummaryLinkCard
            ...
            description="Equipos listos para retiro y coordinacion final."
            to="/admin/repairs"
            tone="success"
          />
          <SummaryLinkCard
            ...
            description="Pedidos todavia activos dentro del flujo comercial."
            to="/admin/orders"
            tone="accent"
          />
          <SummaryLinkCard
            ...
            description="Productos que necesitan reposicion o revision urgente."
            to="/admin/productos"
            tone="danger"
          />
        </div>
...
export function AdminDashboardWorkQueueSection({
  loading,
  workQueue,
}: {
  loading: boolean;
...
export function AdminDashboardMetricsSection({
  loading,
  summary,
}: {
  loading: boolean;
