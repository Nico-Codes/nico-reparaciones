...
const ICONS_BY_NAME: Record<VisualIconName, ReactNode> = {
  ...
  issueScreen: <MonitorX className="h-7 w-7" />,
  issueBattery: <BatteryWarning className="h-7 w-7" />,
  issueCharge: <PlugZap className="h-7 w-7" />,
  issueBoard: <Cpu className="h-7 w-7" />,
  issueCamera: <Camera className="h-7 w-7" />,
  issueAudio: <Volume2 className="h-7 w-7" />,
  issueSoftware: <Code2 className="h-7 w-7" />,
  issueWater: <Droplets className="h-7 w-7" />,
  issueGeneric: <HelpCircle className="h-7 w-7" />,
};
