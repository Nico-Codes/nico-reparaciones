...
export class RepairsSupportService {
  ...
  serializeRepairPricingSnapshot(snapshot: RepairPricingSnapshot) {
    return {
      ...
      internalProductId: snapshot.internalProductId ?? null,
      internalProductNameSnapshot: snapshot.internalProductNameSnapshot ?? null,
      internalProductSkuSnapshot: snapshot.internalProductSkuSnapshot ?? null,
      internalProductApplicabilityId: snapshot.internalProductApplicabilityId ?? null,
      internalProductStockBefore: snapshot.internalProductStockBefore ?? null,
      internalProductStockAfter: snapshot.internalProductStockAfter ?? null,
