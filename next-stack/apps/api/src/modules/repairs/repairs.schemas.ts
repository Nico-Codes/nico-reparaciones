...
export const createRepairSchema = z.object({
  ...
  pricingSnapshotDraft: z.object({
    source: z.enum(['SUPPLIER_PART', 'INTERNAL_STOCK']),
    ...
    internalProductId: z.string().trim().max(191).optional().nullable(),
    internalProductNameSnapshot: z.string().trim().max(300).optional().nullable(),
    internalProductSkuSnapshot: z.string().trim().max(191).optional().nullable(),
    internalProductApplicabilityId: z.string().trim().max(191).optional().nullable(),
    internalProductStockBefore: z.number().int().min(0).optional().nullable(),
    internalProductStockAfter: z.number().int().min(0).optional().nullable(),
