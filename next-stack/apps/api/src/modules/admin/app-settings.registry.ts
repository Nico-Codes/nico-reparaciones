...
{ key: 'brand_asset.icon_verificar_correo.path', group: 'branding', label: 'Icono verificar correo', type: 'text', defaultValue: 'icons/v4/verificar-correo.svg', owner: 'branding' },
...
{ key: 'brand_asset.icon_admin_reparaciones.path', group: 'branding', label: 'Icono admin reparaciones', type: 'text', defaultValue: 'icons/v4/admin-reparaciones.svg', owner: 'branding' },
...
export const BRAND_ASSET_SLOTS = {
  ...
  icon_consultar_reparacion: { settingKey: 'brand_asset.icon_consultar_reparacion.path', defaultPath: 'icons/v4/consultar-reparacion.svg', fileBase: 'icon-consultar-reparacion', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  ...
  icon_mis_reparaciones: { settingKey: 'brand_asset.icon_mis_reparaciones.path', defaultPath: 'icons/v4/mis-reparaciones.svg', fileBase: 'icon-mis-reparaciones', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  ...
  icon_verificar_correo: { settingKey: 'brand_asset.icon_verificar_correo.path', defaultPath: 'icons/v4/verificar-correo.svg', fileBase: 'icon-verificar-correo', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  ...
  icon_admin_reparaciones: { settingKey: 'brand_asset.icon_admin_reparaciones.path', defaultPath: 'icons/v4/admin-reparaciones.svg', fileBase: 'icon-admin-reparaciones', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
