...
{ key: 'brand_asset.checkout_payment_local.path', group: 'branding', label: 'Icono checkout pago en local', type: 'text', defaultValue: 'icons/v4/payment-local.svg', owner: 'branding' },
{ key: 'brand_asset.checkout_payment_transfer.path', group: 'branding', label: 'Icono checkout transferencia', type: 'text', defaultValue: 'icons/v4/payment-transfer.svg', owner: 'branding' },
{ key: 'brand_asset.icon_ayuda.path', group: 'branding', label: 'Icono ayuda', type: 'text', defaultValue: 'icons/v4/ayuda.svg', owner: 'branding' },
{ key: 'brand_asset.icon_mi_cuenta.path', group: 'branding', label: 'Icono mi cuenta', type: 'text', defaultValue: 'icons/v4/mi-cuenta.svg', owner: 'branding' },
{ key: 'brand_asset.icon_verificar_correo.path', group: 'branding', label: 'Icono verificar correo', type: 'text', defaultValue: 'icons/v5/verificar-correo.svg', owner: 'branding' },
{ key: 'brand_asset.icon_admin_pedidos.path', group: 'branding', label: 'Icono admin pedidos', type: 'text', defaultValue: 'icons/v4/admin-pedidos.svg', owner: 'branding' },
{ key: 'brand_asset.icon_admin_reparaciones.path', group: 'branding', label: 'Icono admin reparaciones', type: 'text', defaultValue: 'icons/v5/admin-reparaciones.svg', owner: 'branding' },
{ key: 'brand_asset.icon_admin_venta_rapida.path', group: 'branding', label: 'Icono admin venta rapida', type: 'text', defaultValue: 'icons/v4/admin-venta-rapida.svg', owner: 'branding' },
{ key: 'brand_asset.icon_admin_productos.path', group: 'branding', label: 'Icono admin productos', type: 'text', defaultValue: 'icons/v4/admin-productos.svg', owner: 'branding' },
...
export const BRAND_ASSET_SLOTS = {
  ...
  checkout_payment_local: { settingKey: 'brand_asset.checkout_payment_local.path', defaultPath: 'icons/v4/payment-local.svg', fileBase: 'checkout-payment-local', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  checkout_payment_transfer: { settingKey: 'brand_asset.checkout_payment_transfer.path', defaultPath: 'icons/v4/payment-transfer.svg', fileBase: 'checkout-payment-transfer', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  ...
  icon_consultar_reparacion: { settingKey: 'brand_asset.icon_consultar_reparacion.path', defaultPath: 'icons/v5/consultar-reparacion.svg', fileBase: 'icon-consultar-reparacion', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  icon_mis_pedidos: { settingKey: 'brand_asset.icon_mis_pedidos.path', defaultPath: 'icons/v4/mis-pedidos.svg', fileBase: 'icon-mis-pedidos', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  icon_mis_reparaciones: { settingKey: 'brand_asset.icon_mis_reparaciones.path', defaultPath: 'icons/v5/mis-reparaciones.svg', fileBase: 'icon-mis-reparaciones', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  icon_dashboard: { settingKey: 'brand_asset.icon_dashboard.path', defaultPath: 'icons/v4/dashboard.svg', fileBase: 'icon-dashboard', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  icon_tienda: { settingKey: 'brand_asset.icon_tienda.path', defaultPath: 'icons/v4/tienda.svg', fileBase: 'icon-tienda', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  icon_ayuda: { settingKey: 'brand_asset.icon_ayuda.path', defaultPath: 'icons/v4/ayuda.svg', fileBase: 'icon-ayuda', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  icon_mi_cuenta: { settingKey: 'brand_asset.icon_mi_cuenta.path', defaultPath: 'icons/v4/mi-cuenta.svg', fileBase: 'icon-mi-cuenta', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  icon_verificar_correo: { settingKey: 'brand_asset.icon_verificar_correo.path', defaultPath: 'icons/v5/verificar-correo.svg', fileBase: 'icon-verificar-correo', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  icon_admin_pedidos: { settingKey: 'brand_asset.icon_admin_pedidos.path', defaultPath: 'icons/v4/admin-pedidos.svg', fileBase: 'icon-admin-pedidos', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  icon_admin_reparaciones: { settingKey: 'brand_asset.icon_admin_reparaciones.path', defaultPath: 'icons/v5/admin-reparaciones.svg', fileBase: 'icon-admin-reparaciones', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  icon_admin_venta_rapida: { settingKey: 'brand_asset.icon_admin_venta_rapida.path', defaultPath: 'icons/v4/admin-venta-rapida.svg', fileBase: 'icon-admin-venta-rapida', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
