...
export const APP_SETTING_DEFINITIONS = [
  ...
  { key: 'brand_asset.checkout_payment_debit.path', group: 'branding', label: 'Icono checkout debito', type: 'text', defaultValue: 'icons/payment-debit.svg', owner: 'branding' },
  { key: 'brand_asset.checkout_payment_credit.path', group: 'branding', label: 'Icono checkout credito', type: 'text', defaultValue: 'icons/payment-credit.svg', owner: 'branding' },
...
export const BRAND_ASSET_SLOTS = {
  ...
  checkout_payment_debit: { settingKey: 'brand_asset.checkout_payment_debit.path', defaultPath: 'icons/payment-debit.svg', fileBase: 'checkout-payment-debit', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
  checkout_payment_credit: { settingKey: 'brand_asset.checkout_payment_credit.path', defaultPath: 'icons/payment-credit.svg', fileBase: 'checkout-payment-credit', maxKb: 2048, allowedExts: ['svg', 'png', 'jpg', 'jpeg', 'webp'] },
