...
export const APP_SETTING_DEFINITIONS = [
  ...
  { key: 'brand_asset.auth_login_background.path', group: 'branding', label: 'Imagen fondo login (desktop)', type: 'text', defaultValue: '', owner: 'branding' },
  { key: 'brand_asset.auth_login_background_mobile.path', group: 'branding', label: 'Imagen fondo login (mobile)', type: 'text', defaultValue: '', owner: 'branding' },
...
export const BRAND_ASSET_SLOTS = {
  ...
  auth_login_background: { settingKey: 'brand_asset.auth_login_background.path', defaultPath: '', fileBase: 'auth-login-background', maxKb: 6144, allowedExts: ['png', 'jpg', 'jpeg', 'webp'] },
  auth_login_background_mobile: { settingKey: 'brand_asset.auth_login_background_mobile.path', defaultPath: '', fileBase: 'auth-login-background-mobile', maxKb: 4096, allowedExts: ['png', 'jpg', 'jpeg', 'webp'] },
